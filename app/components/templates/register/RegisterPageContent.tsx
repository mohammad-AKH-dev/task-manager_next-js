      ...
      >
        ...
        <div className="register-inputs__wrapper max-w-[400px] mx-auto md:mx-0 md:max-w-[600px] grid grid-cols-2 gap-6">
          <div className="input-wrapper flex flex-col gap-y-2">
            ...
            />
            {
              errors.username && <span className="text-[10px] translate-x-1 -translate-y-1 text-red-600">{errors.username.message}</span>
            }
          </div>
          <div className="input-wrapper flex flex-col gap-y-2">
            ...
            />
            {
              errors.email && <span className="text-[10px] translate-x-1 -translate-y-1 text-red-600">{errors.email.message}</span>
            }
          </div>
          <div className="input-wrapper relative flex flex-col gap-y-2">
            ...
            />
            {
              errors.password && <span className="text-[10px] translate-x-1 -translate-y-1 text-red-600">{errors.password.message}</span>
            }
          ...
          <div className="input-wrapper flex flex-col gap-y-2">
            ...
            />
            {
              errors.adminToken && <span className="text-[10px] translate-x-1 -translate-y-1 text-red-600">{errors.adminToken.message}</span>
            }
          </div>
        </div>
        <button
